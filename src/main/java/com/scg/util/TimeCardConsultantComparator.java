...
public class TimeCardConsultantComparator implements Comparator<TimeCard> {
	...
	public int compare(TimeCard card1, TimeCard card2) {
		...
		if (card1 == null || card2 == null) {
			returnValue = NullObjectCompare.nullObjectsComparator(card1, card2);
			if (returnValue != 0 ) {
				return returnValue;
			}
			...
			if (consultant1 == null  || consultant2 == null) {
				returnValue = NullObjectCompare.nullObjectsComparator(consultant1, consultant2);
				if (  returnValue != 0 ) {
					return returnValue;
				};
				...
				if (returnValue != 0 ) {
					...
					if (week1 == null || week2 == null) {
						returnValue = NullObjectCompare.nullObjectsComparator(week1, week2);
						if (  returnValue != 0 ) {
							return returnValue;
						}else {
							...
							if (returnValue != 0){
								return returnValue;
								// now, consultant1 == consultant2 and week1 == week2		
							} else {
